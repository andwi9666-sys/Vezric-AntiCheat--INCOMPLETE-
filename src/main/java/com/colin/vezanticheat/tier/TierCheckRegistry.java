...
import com.colin.vezanticheat.tier.characteristics.CharAimSensitivity;
...
import com.colin.vezanticheat.tier.prism.PrismAimDuplicate;
import com.colin.vezanticheat.tier.prism.PrismAimModulo360;
...
import com.colin.vezanticheat.tier.prism.PrismBadPacketsG;
import com.colin.vezanticheat.tier.prism.PrismBadPacketsH;
import com.colin.vezanticheat.tier.prism.PrismBadPacketsI;
import com.colin.vezanticheat.tier.prism.PrismBadPacketsJ;
import com.colin.vezanticheat.tier.prism.PrismBadPacketsK;
import com.colin.vezanticheat.tier.prism.PrismBadPacketsL;
import com.colin.vezanticheat.tier.prism.PrismBadPacketsM;
...
import com.colin.vezanticheat.tier.prism.PrismMultiActionsC;
import com.colin.vezanticheat.tier.prism.PrismMultiActionsD;
import com.colin.vezanticheat.tier.prism.PrismMultiActionsE;
import com.colin.vezanticheat.tier.prism.PrismMultiActionsF;
import com.colin.vezanticheat.tier.prism.PrismMultiActionsG;
import com.colin.vezanticheat.tier.prism.PrismNukerA;
...
import com.colin.vezanticheat.tier.prediction.PredictionNegativeTimer;
...
public final class TierCheckRegistry {
    ...
    public TierCheckRegistry(VezAntiCheat plugin) {
        ...
        add(new CharAimSensitivity(plugin));
        ...
        add(new PrismAimModulo360(plugin));
        add(new PrismAimDuplicate(plugin));
        ...
        add(new PrismBadPacketsG(plugin));
        add(new PrismBadPacketsH(plugin));
        add(new PrismBadPacketsI(plugin));
        add(new PrismBadPacketsJ(plugin));
        add(new PrismBadPacketsK(plugin));
        add(new PrismBadPacketsL(plugin));
        add(new PrismBadPacketsM(plugin));
        add(new PrismMultiActionsA(plugin));
        add(new PrismMultiActionsB(plugin));
        add(new PrismMultiActionsC(plugin));
        add(new PrismMultiActionsD(plugin));
        add(new PrismMultiActionsE(plugin));
        add(new PrismMultiActionsF(plugin));
        add(new PrismMultiActionsG(plugin));
        ...
        add(new PredictionNegativeTimer(plugin));
